...
@Testcontainers
@org.junit.jupiter.api.condition.DisabledIfEnvironmentVariable(named = "APP_BASE_URL", matches = ".+", disabledReason = "Replaced by FullEndpointCoverageIT when run_test.sh is driving the compose stack")
