    ...
    public Map<String, Object> bookingById(long bookingOrderId) {
        return jdbcTemplate.query(
            ...
            rs -> {
                ...
                row.put("location_id", rs.getLong("location_id"));
                row.put("customer_name", rs.getString("customer_name"));
                row.put("customer_phone", rs.getString("customer_phone"));
                row.put("customer_name_enc", rs.getString("customer_name_enc"));
                row.put("customer_phone_enc", rs.getString("customer_phone_enc"));
                row.put("start_at", rs.getObject("start_at", LocalDateTime.class));
                row.put("end_at", rs.getObject("end_at", LocalDateTime.class));
